...
// frontend stuff
// showEndpoint is main page listener
func showEndpoint(w http.ResponseWriter, req *http.Request) {
	//var test Res
	test := make([]Res, 0)
...
func main() {
    ...
    router.HandleFunc("/cliffcast", showEndpoint).Methods("GET")
